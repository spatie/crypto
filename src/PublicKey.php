...
class PublicKey
{
    ...
    {
        openssl_public_encrypt($data, $encrypted, $this->publicKeyString, OPENSSL_PKCS1_OAEP_PADDING);
    ...
    {
        openssl_public_decrypt($data, $decrypted, $this->publicKeyString, OPENSSL_PKCS1_PADDING);
